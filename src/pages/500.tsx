...
function ServerFailure() {
  return (
    <Layout centered>
      <Metadata path='' title='No page found' />
      <Container>
        <div className='flex flex-col md:flex-row items-center justify-center text-gray-700'>
          <div>
            <div className='text-5xl font-dark font-bold'>500</div>
            <p className='text-2xl md:text-3xl font-light leading-normal'>Internal server error. </p>
            <p className='mb-8'>Something went wrong in the server.</p>
          ...
          <svg className='max-w-md w-full' id='Layer_1' data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 2395 1800'>
            <defs></defs>
            <title>cat</title>
            <path
              className='cls-1'
